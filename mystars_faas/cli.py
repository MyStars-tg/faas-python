...
from ._validate import PAYMENT_CURRENCIES
...
_CURRENCY_HELP = "ton (the native GRAM coin) or usdt_ton (USDT)"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    pr.add_argument("--currency", required=True, choices=PAYMENT_CURRENCIES, help=_CURRENCY_HELP)
    ...
    oc.add_argument("--currency", required=True, choices=PAYMENT_CURRENCIES, help=_CURRENCY_HELP)
